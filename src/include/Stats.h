...
class TourStats {
	...
	public: 
        ...
        std::vector<std::vector<int>> groupsOwner;
	...
	void randomStats() {
			...
			steps = 1;
                        ...
                        groupsDegree.push_back(Randness::getInstance()->get_a_random_number(20,30));
                        groupsSize.push_back(Randness::getInstance()->get_a_random_number(10,20));
