...
int main(int argc, char **argv) {
	...
	{ 
        ...
        desc.add_options()
                ...
                ("supernode,s", po::value<int>()->required(), "Super Node Size")
	...
	while(true) {
		...
		EmbeddingSpaceRGPM<VertexInducedEmbedding,AggregatorPatternCounter> es(k, supernode, &g.first, config, configString, thread);
		es.run_rw();	
